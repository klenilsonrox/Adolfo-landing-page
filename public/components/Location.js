...
export function Location() {
  return (
    <section id="localizacao" className="bg-slate-50 py-20">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-gray-600">
            Visite meu escritório para uma consulta presencial ou agende um atendimento online.
          </p>
        </motion.div>
          ...
          >
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Av. Paulista, 1500, Sala 501</p>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Sábado: Mediante agendamento</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Email: adolfo@advogado.com</p>
              </div>
            </div>
          </motion.div>
