      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-gray-600">
            Estou à disposição para ajudar você a resolver suas questões jurídicas. Entre em contato para agendar uma
          ...
          >
            ...
            <div className="space-y-6">
              <a
                ...
                className="flex items-center space-x-4 rounded-lg border border-gray-200 p-4 transition-colors hover:bg-slate-50"
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">@advogado.adolfo</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Advogado Adolfo Mendes</p>
                </div>
              </a>
